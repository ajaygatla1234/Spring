...
public class SpringMain {
	...
	public static void main(String[] args) {
		...
		teacher1.getHomeWork();  // Invoke the getHomeWork method for MathTeacher
		teacher2.getHomeWork();  // Invoke the getHomeWork method for HindiTeacher
		
		// Print exam tips for each teacher
